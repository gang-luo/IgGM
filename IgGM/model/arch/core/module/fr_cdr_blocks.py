...
class CDRFusionBlock(nn.Module):
    ...
    def build_outputs(
        ...
        *,
        ...
        clean_fr_ref = clean_fr_ref.to(device=merged_coords.device, dtype=fr_coords.dtype)
        ...
        clean_local = clean_local.to(device=merged_coords.device, dtype=merged_coords.dtype)
